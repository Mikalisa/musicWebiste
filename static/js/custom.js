	...
	*/
	...
	function initAlbumPlayer()
	{
		if($('#jplayer_2').length)
		{
			...
			[
				{
					...
					artist:"Bensound",
					album:"Ocean Vibes",
					mp3:"/home/ubuntu/workspace/final_project/songs/onclassical_luisi_bach_partita_B-flat-major_bwv-825_4.mp3",
			...
			myPlaylist = new jPlayerPlaylist(cssSel,playlist,options);
